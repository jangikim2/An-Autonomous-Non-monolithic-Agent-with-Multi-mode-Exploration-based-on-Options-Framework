...
def get_params():
    ...
    default_params = {"env_name": "MontezumaRevengeNoFrameskip-v4",
                      ...
                      #######################################
                      "action_std_init": 0.1,  # set same std for action distribution which was used while saving
                      "n_workers": 1,
                      "rollout_length": 2,
                      "interval": 50,
                      "state_shape": 30,
                      ...
                      ##"n_actions": 15,
                      "n_actions": 3,
                      "n_pre_tar_actions": 80,
                      "n_meta_context": 3,
                      "train_from_scratch": True,
                      "predictor_proportion": 32
                      ####"predictor_proportion": 32 / config["n_workers"]
                      #######################################
                      }
