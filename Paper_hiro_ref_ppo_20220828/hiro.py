    ...
    for t in range(step, max_timestep):
        ...
        if (t + 1) % c == 0 and t > 0:
            ...
            if t < start_timestep:
                ...
                if (t + 1) >= update_timestep_ppo and (t + 1) % update_timestep_ppo == 0:
                    ##############################################################################################################
                ...
                if (t + 1) >= (start_timestep + update_timestep_ppo) and (t + 1) % update_timestep_ppo == 0:
                    ##############################################################################################################
                    error_logs = ppo_agent.train()
